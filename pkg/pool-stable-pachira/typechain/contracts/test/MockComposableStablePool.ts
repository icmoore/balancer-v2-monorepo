...
export interface MockComposableStablePoolInterface extends utils.Interface {
  functions: {
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "beforeJoinExit(uint256[])": FunctionFragment;
    ...
    "mockCacheTokenRateIfNecessary(uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "mockCacheTokenRateIfNecessary"
      | "mockCacheTokenRateIfNecessary(uint256)"
      | "name"
      | "name()"
      | "nonces"
      | "nonces(address)"
  ...
  encodeFunctionData(
    functionFragment: "beforeJoinExit",
    values: [PromiseOrValue<BigNumberish>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "beforeJoinExit(uint256[])",
    values: [PromiseOrValue<BigNumberish>[]]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "mockCacheTokenRateIfNecessary",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "mockCacheTokenRateIfNecessary(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
...
export interface MockComposableStablePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockComposableStablePoolInterface;
  ...
  callStatic: {
    ...
    beforeJoinExit(
      ...
      [BigNumber, BigNumber[], BigNumber, BigNumber] & {
        preJoinExitSupply: BigNumber;
        balances: BigNumber[];
        currentAmp: BigNumber;
        preJoinExitInvariant: BigNumber;
      }
    >;
