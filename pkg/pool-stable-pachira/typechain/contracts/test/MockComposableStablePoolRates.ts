...
export interface MockComposableStablePoolRatesInterface
  ...
  functions: {
    ...
    "cacheTokenRateIfNecessary(address)": FunctionFragment;
    "cacheTokenRatesIfNecessary()": FunctionFragment;
    "decimals()": FunctionFragment;
    "decreaseAllowance(address,uint256)": FunctionFragment;
    "disableRecoveryMode()": FunctionFragment;
    "enableRecoveryMode()": FunctionFragment;
    "getActionId(bytes4)": FunctionFragment;
    "getAdjustedBalances(uint256[],bool)": FunctionFragment;
    ...
    "updateOldRates()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "balanceOf"
      | "balanceOf(address)"
      | "cacheTokenRateIfNecessary"
      | "cacheTokenRateIfNecessary(address)"
      | "cacheTokenRatesIfNecessary"
      | "cacheTokenRatesIfNecessary()"
      | "decimals"
      | "decimals()"
      | "decreaseAllowance"
      ...
      | "getActionId(bytes4)"
      | "getAdjustedBalances"
      | "getAdjustedBalances(uint256[],bool)"
      | "getAuthorizer"
      | "getAuthorizer()"
      | "getBptIndex"
      | "getBptIndex()"
  ...
  encodeFunctionData(
    functionFragment: "cacheTokenRateIfNecessary",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "cacheTokenRateIfNecessary(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "cacheTokenRatesIfNecessary",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "cacheTokenRatesIfNecessary()",
  ...
  encodeFunctionData(
    functionFragment: "getAdjustedBalances",
    values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
    functionFragment: "getAdjustedBalances(uint256[],bool)",
    values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "unpause()", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "updateOldRates",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "updateOldRates()",
...
export interface MockComposableStablePoolRates extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockComposableStablePoolRatesInterface;
  ...
  functions: {
    ...
    getAdjustedBalances(
      ...
      ignoreExemptFlags: PromiseOrValue<boolean>,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]]>;
  ...
  callStatic: {
    ...
    cacheTokenRatesIfNecessary(overrides?: CallOverrides): Promise<void>;
    ...
    updateOldRates(overrides?: CallOverrides): Promise<void>;
