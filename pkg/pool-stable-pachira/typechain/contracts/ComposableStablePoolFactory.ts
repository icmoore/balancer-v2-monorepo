...
export interface ComposableStablePoolFactoryInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "create"
      | "create(string,string,address[],uint256,address[],uint256[],bool[],uint256,address,bytes32)"
      | "disable"
      | "disable()"
      | "getActionId"
      | "getActionId(bytes4)"
  ...
  encodeFunctionData(
    functionFragment: "create(string,string,address[],uint256,address[],uint256[],bool[],uint256,address,bytes32)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>[],
