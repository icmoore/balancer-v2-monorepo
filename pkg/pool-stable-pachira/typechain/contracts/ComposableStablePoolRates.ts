...
export interface ComposableStablePoolRatesInterface extends utils.Interface {
  functions: {
...
export interface ComposableStablePoolRates extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComposableStablePoolRatesInterface;
