...
export interface ComposableStablePoolStorageInterface extends utils.Interface {
  functions: {
...
export interface ComposableStablePoolStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComposableStablePoolStorageInterface;
