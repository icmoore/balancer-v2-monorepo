...
export interface TimelockAuthorizerManagementInterface extends utils.Interface {
  functions: {
...
export interface TimelockAuthorizerManagement extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TimelockAuthorizerManagementInterface;
