...
export interface ComposableStablePoolProtocolFeesInterface
...
export interface ComposableStablePoolProtocolFees extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComposableStablePoolProtocolFeesInterface;
