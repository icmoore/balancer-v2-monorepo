...
import type {
  ITimelockAuthorizer,
  ITimelockAuthorizerInterface,
} from "../../../../../@balancer-labs/v2-interfaces/contracts/vault/ITimelockAuthorizer";
...
export class ITimelockAuthorizer__factory {
  static readonly abi = _abi;
  static createInterface(): ITimelockAuthorizerInterface {
    return new utils.Interface(_abi) as ITimelockAuthorizerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ITimelockAuthorizer {
    return new Contract(address, _abi, signerOrProvider) as ITimelockAuthorizer;
  }
}
