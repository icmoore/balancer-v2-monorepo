...
import type {
  ...
  TimelockAuthorizerManagementInterface,
} from "../../../contracts/authorizer/TimelockAuthorizerManagement";
...
export class TimelockAuthorizerManagement__factory {
  static readonly abi = _abi;
  static createInterface(): TimelockAuthorizerManagementInterface {
    return new utils.Interface(_abi) as TimelockAuthorizerManagementInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as TimelockAuthorizerManagement;
  }
}
