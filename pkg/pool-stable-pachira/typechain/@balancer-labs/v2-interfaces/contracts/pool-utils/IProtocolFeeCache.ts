...
export interface IProtocolFeeCacheInterface extends utils.Interface {
  functions: {
...
export interface IProtocolFeeCache extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IProtocolFeeCacheInterface;
