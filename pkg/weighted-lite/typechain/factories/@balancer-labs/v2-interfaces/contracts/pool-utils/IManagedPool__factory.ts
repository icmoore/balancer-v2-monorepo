...
import type {
  IManagedPool,
  IManagedPoolInterface,
} from "../../../../../@balancer-labs/v2-interfaces/contracts/pool-utils/IManagedPool";
...
export class IManagedPool__factory {
  static readonly abi = _abi;
  static createInterface(): IManagedPoolInterface {
    return new utils.Interface(_abi) as IManagedPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IManagedPool {
    return new Contract(address, _abi, signerOrProvider) as IManagedPool;
  }
}
