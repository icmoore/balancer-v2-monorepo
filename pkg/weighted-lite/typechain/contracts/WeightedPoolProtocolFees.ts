...
export interface WeightedPoolProtocolFeesInterface extends utils.Interface {
  functions: {
...
export interface WeightedPoolProtocolFees extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WeightedPoolProtocolFeesInterface;
