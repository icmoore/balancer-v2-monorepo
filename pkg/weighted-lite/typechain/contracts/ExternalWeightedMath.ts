...
export interface ExternalWeightedMathInterface extends utils.Interface {
  functions: {
...
export interface ExternalWeightedMath extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExternalWeightedMathInterface;
