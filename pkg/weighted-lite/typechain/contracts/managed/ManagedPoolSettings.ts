...
export interface ManagedPoolSettingsInterface extends utils.Interface {
  functions: {
...
export interface ManagedPoolSettings extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ManagedPoolSettingsInterface;
