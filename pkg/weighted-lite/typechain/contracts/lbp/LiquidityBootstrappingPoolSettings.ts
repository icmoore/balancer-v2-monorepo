...
export interface LiquidityBootstrappingPoolSettingsInterface
...
export interface LiquidityBootstrappingPoolSettings extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityBootstrappingPoolSettingsInterface;
