...
export interface TestTokenInterface extends utils.Interface {
  functions: {
    ...
    "burnWithoutAllowance(address,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "burnWithoutAllowance"
      | "burnWithoutAllowance(address,uint256)"
      | "decimals"
      | "decimals()"
      | "decreaseAllowance"
  ...
  encodeFunctionData(
    functionFragment: "burnWithoutAllowance",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "burnWithoutAllowance(address,uint256)",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
