...
export interface IAuthorizerAdaptorEntrypointInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "performAction(address,bytes)",
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]
  ): string;
...
export interface IAuthorizerAdaptorEntrypoint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAuthorizerAdaptorEntrypointInterface;
