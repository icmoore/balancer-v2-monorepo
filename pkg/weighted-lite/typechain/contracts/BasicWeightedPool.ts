...
export declare namespace BasicWeightedPool {
...
export interface BasicWeightedPoolInterface extends utils.Interface {
  functions: {
...
export interface BasicWeightedPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BasicWeightedPoolInterface;
