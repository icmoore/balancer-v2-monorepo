...
import type {
  ManagedPoolSettings,
  ManagedPoolSettingsInterface,
} from "../../../contracts/managed/ManagedPoolSettings";
...
export class ManagedPoolSettings__factory {
  static readonly abi = _abi;
  static createInterface(): ManagedPoolSettingsInterface {
    return new utils.Interface(_abi) as ManagedPoolSettingsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ManagedPoolSettings {
    return new Contract(address, _abi, signerOrProvider) as ManagedPoolSettings;
  }
}
