...
export interface MockManagedPoolSettingsInterface extends utils.Interface {
  functions: {
    ...
    "isAllowedAddress(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isAllowedAddress",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "isAllowedAddress(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface MockManagedPoolSettings extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockManagedPoolSettingsInterface;
