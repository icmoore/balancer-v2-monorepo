...
export interface LiquidityBootstrappingPoolFactoryInterface
  extends utils.Interface {
  functions: {
    "create(string,string,address[],uint256[],uint256,address,bool,bytes32)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "create"
      | "create(string,string,address[],uint256[],uint256,address,bool,bytes32)"
      | "disable"
      | "disable()"
      | "getActionId"
      | "getActionId(bytes4)"
  ...
  encodeFunctionData(
    functionFragment: "create(string,string,address[],uint256[],uint256,address,bool,bytes32)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>[],
...
export interface LiquidityBootstrappingPoolFactory extends BaseContract {
