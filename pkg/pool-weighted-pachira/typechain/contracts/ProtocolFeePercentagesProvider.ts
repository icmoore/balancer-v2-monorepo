...
export interface ProtocolFeePercentagesProviderInterface
...
export interface ProtocolFeePercentagesProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProtocolFeePercentagesProviderInterface;
